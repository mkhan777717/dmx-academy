...
export default function MentorLogin() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const isLoggedIn = localStorage.getItem("synapse_mentor_session");
      if (isLoggedIn) {
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <h1 className="text-3xl font-black font-display tracking-tight text-gradient">
            Eduvantix Mentor Board
          </h1>
          <p className="text-xs font-semibold" style={{ color: "var(--text-secondary)" }}>
            Eduvantix Instruction & Mentorship Hub
          </p>
        </motion.div>
        ...
        >
          <div className="space-y-1">
            ...
            <p className="text-xs" style={{ color: "var(--text-secondary)" }}>
              Access your instructional panel, review student work, and manage tracks
            </p>
          </div>
